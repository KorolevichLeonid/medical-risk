...
class Project(Base):
    ...
    document_versions = relationship("DocumentVersion", back_populates="project", overlaps="documents")
    documents = relationship("DocumentVersion", back_populates="project", overlaps="document_versions")
